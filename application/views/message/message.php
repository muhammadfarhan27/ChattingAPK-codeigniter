	...
	<section id="main" class="bg-dark">
		<div id="chat_user_list">
			...
			<div style="margin-left: 40px;">
				<p><a style="color:black;" href="http://localhost:8000/">Untuk Forum Chat Klik Disini</a></p>
			</div>
			<div style="margin-left: 40px; position:bottom;">
				<p><a href="http://localhost:8080/"><i>Pertanyaan yang paling sering</i></a></p>
			</div>
			<hr/>
